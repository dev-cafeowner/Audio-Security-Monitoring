...
저장소는 `Vivado/`, `Vitis/`, `PC_UI/`로 구성됩니다. PC UI에는 Python 소스, 의존성 목록과 527개 AudioSet 클래스 이름 데이터가 포함됩니다. 비트스트림, XSA, ELF, 모델 가중치와 데모 오디오 데이터는 포함하지 않습니다.
